...
export default hopeTheme({
  ...
  blog: {
    medias: {
      BiliBili: "https://space.bilibili.com/472499034?spm_id_from=333.1007.0.0",
      Discord: "https://example.com",
      Email: "https://account.microsoft.com/profile?refd=account.microsoft.com",
      Gitee: "https://gitee.com/xunya/dashboard/projects",
      GitHub: "https://github.com/StudioFn",
      QQ: "http://wpa.qq.com/msgrd?v=3&uin=2308762185&site=qq&menu=yes",
      Zhihu: "https://www.zhihu.com/people/22-33-60-82",
      // MrHope: [
      //   "https://mrhope.site",
  ...
  locales: {
    "/": {
      ...
      blog: {
        description: "自律，说起来简单，落下去复杂，听起来像感觉，做起来是原则",
        intro: "/intro.html",
      },
